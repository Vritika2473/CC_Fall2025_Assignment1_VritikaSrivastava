...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://t279jhnzka.execute-api.us-east-2.amazonaws.com/default/LF0'; // Updated by Vritika - Dining Concierge API Gateway endpoint
    ...
    apigClient.chatbotPost = function (params, body, additionalParams) {
        ...
        var nluPostRequest = {
            ...
            // send directly to LF0 endpoint (no /chatbot suffix)
            path: pathComponent,
